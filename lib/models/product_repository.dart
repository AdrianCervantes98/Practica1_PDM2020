...
class ProductRepository {
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if(prodType == ProductType.TAZAS)
      return <ProductCup>[
        ProductCup(
          productTitle: "Taza Cuphead",
          productDescription: "Taza del personaje Cuphead del popular videojuego Cuphead.",
          productImage: "https://planetfanshop.com/31808-home_default_2x/taza-cuphead-caras.jpg",
          productColor: ProductColor.BLANCO,
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza One Piece",
          productDescription: "Taza de la popular serie anime One Piece.",
          productImage: "https://www.tokyoshop.es/data/productos/merchandising/MERCH5427-D.jpg",
          productColor: ProductColor.BLANCO,
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza Ghosts",
          productDescription: "Taza del popular videojuego Call Of Duty: Ghosts.",
          productImage: "https://www.detodojuego.com/wp-content/uploads/2018/09/11-81-300x300.png",
          productColor: ProductColor.BLANCO,
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza Vikinga",
          productDescription: "Taza vikinga de una calavera con casco.",
          productImage: "https://www.los-vikingos.com/wp-content/uploads/2018/11/taza_vikinga.png",
          productColor: ProductColor.BLANCO,
          productAmount: 0,
        ),
        ProductCup(
          productTitle: "Taza Steven Universe",
          productDescription: "Taza de la popular caricatura Steven Universe.",
          productImage: "https://static.fnac-static.com/multimedia/Images/ES/MC/a0/d3/5a/5952416/1540-1/tsp20170919205312/Taza-Steven-Universe-Star.jpg",
          productColor: ProductColor.BLANCO,
          productAmount: 0,
        ),
      ];
